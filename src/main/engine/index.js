...
alert.source = 'zkill';
alert.url = kill.url;
alert.finalBlowChar = kill.finalBlowChar || 'Unknown';
alert.finalBlowShip = kill.finalBlowShip || 'Unknown Ship';
alert.finalBlowCorp = kill.finalBlowCorp || 'Unknown Corp';
alert.attackers = kill.attackers || 0;
